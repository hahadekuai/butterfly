define('spec.util.CssValidator', 
	['require', 'jQuery', 'util.CssValidator', 'ui.Validation', 'util.CssValidatorPropertiesFilter'], 
	function(require, $, CssValidator) {

describe(this.id + ' - 验证CSS对象符合一定的业务规则', function() {
	...
	it('验证只包含指定的选择器', function() {
		...
		expect(validator.result.node).toBe(css[3]);
	});
