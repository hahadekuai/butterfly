define('doc.page.NavData', {
	...
	ui: ['UI', 'Widget', 'PlaceHolder', 'LazyInitializer', 'Paging', 'InplaceEditor', 'ColorChooser', 'FileUploader'],
	fx: ['Effect', 'Tabs', 'Roll', 'Popup', 'Accordion', 'CountDown', 'Marquee']
});
